...
FnsToEvaluate.K=@(aprime,a,z,w,r,lambda,delta,alpha,upsilon) f_capitaldemand(aprime,a,z,w,r,lambda,delta,alpha,upsilon); 
% Labor demand by entre (zero if worker)
FnsToEvaluate.L=@(aprime,a,z,w,r,lambda,delta,alpha,upsilon) f_labordemand(aprime,a,z,w,r,lambda,delta,alpha,upsilon); 
% 1 if entrepreneur, 0 if worker
FnsToEvaluate.entrepreneur=@(aprime,a,z,w,r,lambda,delta,alpha,upsilon) f_entrepreneur(aprime,a,z,w,r,lambda,delta,alpha,upsilon);
